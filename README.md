...
### 🎓 Sobre Mim
- 🏫 Estudante do 3º ano do **Curso Técnico em Informática Integrado ao Ensino Médio** no **IFPB Campus João Pessoa**.
- 💼 Estagiária na **CSMTI** (Coordenação de Suporte e Manutenção em TI) do IFPB.
- 🎯 Objetivo de carreira: Futura estudante de **Engenharia de Software no IFPB**!
